        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="page-heading">
                    ...
                    <span class="subheading">Categories as follows.</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-8 col-lg-8 col-xl-7">
                ...
                <div class="post-preview">
                    ...
                    <span>Category : <a
                            href="{{ route('categoryviewpage', $post->category->slug ) }}">{{ $post->category->title }}</a>
                    </span></br>
                    <span>Tags :</span>
                    @forelse ($post->tags as $tag)
                    <span class="badge rounded-pill text-bg-info"><a
                            href="{{ route('tagviewpage',$tag->slug) }}">{{ $tag->title }}</a></span>
                    @empty
                ...
                <div class="card">
                    ...
                    <ol class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <a href="{{ route('categoryviewpage',$category->slug) }}"
                                class="ms-2 me-auto ">{{ $category->slug }}</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="badge rounded-pill text-bg-primary"
                            href="{{ route('tagviewpage',$tag->slug) }}">{{ $tag->title }}</a>
                        @empty
